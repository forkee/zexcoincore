 ...
 *
 *   // network
 *   CZexCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zexcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZexCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CZexCoinNetwork(UniValue objIn)
    {
...
// // can be under: ZexCoinNetwork
// //   -- signature requirements : Key1(User)
// class CZexCoinNetworkVariable : public CGovernanceObject
// {
// private:
