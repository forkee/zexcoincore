...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZexCoinNetwork") type = ZexCoinNetwork;
    if(strType == "ZexCoinNetworkVariable") type = ZexCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZexCoinNetwork) s = "ZexCoinNetwork";
    if(type == ZexCoinNetworkVariable) s = "ZexCoinNetworkVariable";
