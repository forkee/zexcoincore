    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("ZexCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About ZexCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  zexcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the ZexCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ZEX, 0.1 ZEX, 1 ZEX and 10 ZEX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://zexcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://zexcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("ZexCoin Core is shutting down...") + "<br /><br />" +
