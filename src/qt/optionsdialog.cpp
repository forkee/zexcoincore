    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ZEX-light"), QVariant("light"));
    ui->theme->addItem(QString("ZEX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("ZEX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ZEX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ZEX-traditional"), QVariant("trad"));
