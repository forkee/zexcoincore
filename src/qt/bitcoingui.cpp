    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ZexCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ZexCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zexcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ZexCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ZexCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ZexCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ZexCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ZexCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a zexcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ZexCoin Core help message to get a list with possible ZexCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ZexCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ZexCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("ZexCoin Core"); // default title
