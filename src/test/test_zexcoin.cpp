...
#define BOOST_TEST_MODULE ZexCoin Test Suite

#include "test_zexcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_zexcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
