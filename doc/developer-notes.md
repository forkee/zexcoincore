...
ZexCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as ZexCoin Core, where everyone uses
...
pay attention to for reviewers of ZexCoin Core code.

General ZexCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: ZexCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
