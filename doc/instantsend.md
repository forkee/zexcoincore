...
This mechanism has been integrated into Bitcore-Node-ZexCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zexcoin/insight-api-zexcoin#web-socket-api](https://github.com/zexcoin/insight-api-zexcoin#web-socket-api)
* API: [https://github.com/zexcoin/insight-api-zexcoin#instantsend-transactions](https://github.com/zexcoin/insight-api-zexcoin#instantsend-transactions)
...
By default, the ZexCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ZexCoin Core daemon:
