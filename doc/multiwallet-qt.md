...
Only requiring some minor changes is zexcoin.cpp.
...
Changes to zexcoin.cpp
----------------------
zexcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
